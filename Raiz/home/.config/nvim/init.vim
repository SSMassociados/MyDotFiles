...
nnoremap <F6> :hi Comment ctermfg=black guifg=black<cr>
nnoremap <F7> :hi Comment term=bold ctermfg=cyan guifg=cyan<cr>
" Abre um terminal em uma janela dividida inferior.
nnoremap <F8> :FloatermToggle<CR>

" Criar cabeçalho padrão para shell script
map <F9> gg0#!/bin/bash
         \<c-o>:r!echo %<cr># <c-o>o
         \# Versão: <c-o>o
         \# Script para:<c-o>o
